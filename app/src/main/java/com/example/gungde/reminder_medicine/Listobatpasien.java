...
public class Listobatpasien extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.activity_listobatpasien, container, false);
        ...
        Query query2 = FirebaseDatabase.getInstance().getReference().child("Friends").child(mCurrent_user_id)
                .orderByChild("kategori_pengguna").equalTo("Keluarga")
                .limitToLast(50);
