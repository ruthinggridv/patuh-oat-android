    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 Log.e("Email", eemail);
                 Toast.makeText(Daftar.this, ""+edisplayname, Toast.LENGTH_LONG).show();
                ...
                if(!TextUtils.isEmpty(edisplayname)&& !TextUtils.isEmpty(eemail)&& !TextUtils.isEmpty(epassword)
                    ...
                    Toast.makeText(Daftar.this,"Harap isi seluruh data!",Toast.LENGTH_SHORT).show();
                }
                   ...
                   mDatabaseReference.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                       ...
                       public void onComplete(@NonNull Task<Void> task) {
                           if (task.isSuccessful()) {
                               ...
                               mpProgressDialog.hide();
                               Toast.makeText(Daftar.this, "Terjadi kesalahan jaringan.Silahkan periksa jaringan Anda!", Toast.LENGTH_LONG).show();
